                ...
                if (users is not null)
                {
                    ...
                    foreach (var item in users)
                    {
                        var email = _userManager
                            ...
                            {
                                email = s.Email,
                                isactive = s.emailActive
                            })
                            .FirstOrDefault();

                        if (email.isactive.Equals(true))
                        {
                            if (count <10)
                            { 
